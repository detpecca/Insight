...
public class QueryLogsTools {
    ...
    private boolean mockEnabled;// 默认false
    ...
    public String getAvailableLogTopics() {
        ...
        try {
            ...
            // 把 output 这个 Java 对象转换成一个 格式化后的 JSON 字符串
    ...
    /**
     * 当 cls.mock-enabled=true 时返回模拟日志
     * 当 cls.mock-enabled=false 时不会查真实 CLS，而是直接返回报错。
     * 查询日志
     * 从云日志服务查询指定条件的日志
     *
     ...
     */
    // @Tool 管“整个方法的说明”、@ToolParam 管“每个参数的说明”
